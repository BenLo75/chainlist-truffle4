...
contract ChainList is Ownable {
  ...
  _;  // _ a placeholder that represents the code of the function that the modifier is applied to.
  } */
  ...
  function kill() public onlyOwner {
    ...
    selfdestruct(owner);  // paass the address of the woner to refund all the potentially remaining funds in the contract.
  }
